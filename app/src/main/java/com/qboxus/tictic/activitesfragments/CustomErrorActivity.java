...
public class CustomErrorActivity extends AppCompatLocaleActivity implements View.OnClickListener {
    ...
    private void callApiForSendReport() {
        ...
        headers.put("Api-Key", Constants.API_KEY_REPORT);
        VolleyRequest.JsonPostRequest(this, Constants.API_URL_REPORT, jsonObject, headers, new Callback() {
            @Override
            public void onResponce(String s) {
                Functions.printLog(Constants.tag,s.toString());
                Functions.showToast(CustomErrorActivity.this, getString(R.string.error_report_send_successfully));

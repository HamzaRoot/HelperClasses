...
public class Constants {
    ...
    public static final String BASE_URL ="https://apps.qboxus.com/tictic/";
    public static final String API_KEY="156c4675-9608-4591-b2ec-427503464aac";
    //for referal deep linking
    public static final String REFERRAL_LINK = BASE_URL+"ref/?code=";

    //remove before send to client
    public static final String API_URL_SORT_ACCOUNT = "https://apps.qboxus.com/phonecontacts/api/addPhoneContacts";
    public static final String API_URL_REPORT = "https://apps.qboxus.com/employee_portal/crash/addCrashReport";
...
//    public static final String AUTH_KEY = "U2FsdGVkX1+vDOmFtNUtJOD5s7mHBHE19FU6iXXCDvlH8O1jcyC67rceesJ81fWMOc5zzzzzzzzzz4zzzzzzzz==";
    ...
    public static final String API_URL = "https://apis.argear.io/";
    public static final String API_KEY_ARGEAR = "3a6da8d3837885565f69d1c3";
    public static final String SECRET_KEY = "bd72254308f4aca5dcb275bb12e80d6be3228b47de47c2c5d7619b04f0d13476";
    public static final String AUTH_KEY = "U2FsdGVkX1+vDOmFtNUtJOD5s7mHBHE19FU6iXXCDvlH8O1jcyC67rceesJ81fWMOc5UfQEqdgCWf4SkjBIsgQ==";

    public final static String APP_AD_COLONY_ID = "appc2e347b482d54cab8b";
    ...
    public static final String privacy_policy="https://apps.qboxus.com/privacypolicy/tictic.html";
    public static final String terms_conditions="https://apps.qboxus.com/privacypolicy/tictic.html";
